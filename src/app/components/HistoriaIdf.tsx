...
const ESCENAS: Array<{ titulo: string; parrafos: string[] }> = [
  ...
  },
  {
    ...
    parrafos: [
      ...
      `Ese día cayeron ${fmt(D.tormenta.totalMm)} mm en total, con ráfagas que llegaron a una intensidad de ${fmt(D.tormenta.maxIntensidadMmH)} mm/h. La lluvia no es pareja: tiene picos cortos y violentos. Esos picos son los que inundan una calle.`,
    ],
  },
  {
    ...
    parrafos: [
      ...
      'Esta plataforma usa los 144 registros reales de cada día. Esa es la diferencia entre estimar una curva IDF y construirla, y es el corazón de esta tesis.',
    ],
  },
  {
  ...
  },
  {
    ...
    parrafos: [
      ...
      'De ahí sale el período de retorno (Tr). Ojo con la trampa: "Tr = 25 años" NO significa que ocurra cada 25 años, sino que cada año hay un 4% de probabilidad de que se supere. La franja dorada es la incertidumbre del ajuste (IC 90%): con series cortas, es honesta y ancha.',
    ],
  },
  {
    ...
    parrafos: [
      ...
      'El cálculo que antes tomaba semanas sale aquí de los datos reales de la estación, listo para citarse.',
    ],
  },
  {
    ...
    <div className="relative">
      ...
      <div className="mb-4">
        <h2 className="flex items-center gap-2 text-2xl font-bold text-card-foreground">
          <BookOpenText className="h-6 w-6 text-accent" /> La historia del dato
        </h2>
